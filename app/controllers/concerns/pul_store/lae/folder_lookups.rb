module PulStore::Lae::FolderLookups
  ...
  included do
    ...
    def get_folder_list_by_box(box_id, docs = 20)
      ...
      fields_to_return = 'prov_metadata__physical_number_isi,prov_metadata__workflow_state_tesim,id,desc_metadata__title_tesim,desc_metadata__genre_tesim,prov_metadata__barcode_tesim'
