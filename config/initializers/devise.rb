...
Devise.setup do |config|
  ...
  #config.cas_login_url = "https://fed.princeton.edu/cas/login"
  #config.cas_logout_url = "https://fed.princeton.edu/cas/logout"
  #config.cas_validate_url = "https://fed.princeton.edu/cas/serviceValidate"
